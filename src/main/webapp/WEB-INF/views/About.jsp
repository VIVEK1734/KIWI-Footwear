...
<head>
    ...
    <title>ABOUT US | KIWI Footwear</title>
	...
	<!-- Image and text -->
		<nav class="navbar navbar-light" style="background-color: black">
			...
			<ul class="nav justify-content-end">
  				...
  				<li class="nav-item">
    				<a class="nav-link" href="" style="color: white" target="_blank">ALL PRODUCTS</a>
  				</li>
  				
  				<li class="nav-item">
    				<a class="nav-link" href="About.jsp" style="color: #90EE90">ABOUT US</a>
  				</li>
	...
	<div class="container-wrapper">
    	<div class="container">
        	<div class="page-header">
            	...
            	<p>
            		<h2>Welcome to KIWI Footwear Online Shopping Site!!!</h2>
            	</p><br> 
            	
            	<h4>
            		<p>Developed By KIWI Company Private Limited</p>
            		<p><b>Email:</b> info@kiwicompany.com.</p>
            		<p><b>Contact No:</b> +91 88563 34007</p>
        		</h4>
        	</div>
		</div>
	</div>
