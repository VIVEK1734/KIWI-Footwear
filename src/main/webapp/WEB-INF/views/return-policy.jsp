...
<head>
    ...
    <title>RETURN AND REFUND POLICY | KIWI Footwear</title>
    ...
    <link href="<c:url value="/css/return-policy.css" />" rel="stylesheet">
	...
	<!-- Image and text -->
		<nav class="navbar navbar-light" style="background-color: black">
			...
			<ul class="nav justify-content-end">
  				...
  				<li class="nav-item">
    				<a class="nav-link" href="return-policy.html" style="color: white" target="_blank">ABOUT US</a>
  				</li>
	...
	<!-- Return Policy -->
		<div class="container">
			<div class="return-policy">
				<h1 style="text-align: center"><strong>Return and Refund Policy</strong></h1><br>
				
				<p>Thank you for shopping at KIWI Footwear.</p>
				...
				<ul>
					...
					<li>
						<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to KIWI Footwear.</p>
					</li>
					...
					<li>
						<p><strong>Website</strong> refers to KIWI Footwear, accessible from <a href="index.jsp" rel="external nofollow noopener" target="_blank" style="color: black">kiwifootwear.com</a></p>
					</li>
				...
				<ul>
					<li>
						<p><strong> Email: </strong> info@kiwicompany.com</p>
					</li>
					<li>
						<p><strong> Visiting this page on our website: </strong> <a href="index.html" rel="external nofollow noopener" target="_blank" style="color: black"><strong>kiwifootwear.com</strong></a></p>
					</li>
					<li>
						<p><strong> Phone Number: </strong> 180 774 9599</p>
					</li>
					<li>
						<p><strong> Postal Mail At: </strong> House No. 1116, HIG Flats, Housing Board Colony, Sector-49, Gurugram, 122001, Haryana, India </p>
				...
				<p>No need to send any where we will Pickup from their homes.</p>
				...
				<ul>
					...
					<li>
						<p><strong> Visiting this page on our Website: </strong> <a href="index.jsp" rel="external nofollow noopener" target="_blank" style="color: black"><strong>kiwifootwear.com</strong></a></p>
					</li>
