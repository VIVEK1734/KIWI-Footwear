...
<head>
    ...
    <title>PRIVACY POLICY | KIWI Footwear</title>
    ...
    <link href="<c:url value="/css/privacy-policy.css" />" rel="stylesheet">
	...
	<!-- Privacy-policy -->
		<div class="container">
			<div class="privacy-notice">
				<h1 style="text-align: center;"><b>Privacy Policy of  KIWI Company Pvt. Ltd</b></h1><br>	
				
				<div>
					<p>
						KIWI Company Pvt. Ltd operates the <strong><a href="index.jsp" style="color: black">kiwifootwear.com</a></strong> website, which provides the SERVICE.
					<p>
				...
				<div class='innerText'>
					<strong><br>If at any time you would like to unsubscribe from receiving future emails, you can email us</strong>&nbsp;and 
					we will promptly remove you from <strong>ALL</strong> correspondence.
				</div>
			</div>
		</div><br>
</body>
